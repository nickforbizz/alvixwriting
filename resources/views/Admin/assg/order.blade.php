    ...
    <div class="row">
        ...
        <div class="">
            ...
            <div>
                ...
                <div class="">
                    <h4>Admin Order Notes</h4> <hr>
                    <p class="well"> {{ $assg->notes }} </p> 
                </div>
        </div>
                    ...
                    <div class="comment-tabs">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="comments-logout">                
                                <ul class="media-list">
                                    @foreach ($comments as $comment)
                                        ...
                                        @if ($comment->posted_by == 'admin')
                                            
                                            <li class="media">
                                                <a class="pull-left" href="#">
                                                <img class="media-object img-circle" height="80px" width="80px" src="{{ asset( 'storage/'.$profileadmin) }}" alt="profile">
                                                </a>
                                                <div class="media-body">
                                                <div class="well well-lg">
                                                    <h4 class="media-heading text-lowercase reviews"> @ {{ Auth::guard('admin')->user()->username }} </h4>
                                        ...
                                        @else
                                            ...
                                            <li class="media">
                                                <a class="pull-right" href="#">
                                                    <img class="media-object img-circle" height="80px" width="80px" src="{{ asset( 'storage/'.$profilewriter) }}" alt="profile">
                                                </a>
                                                <div class="media-body">
                                                    <div class="well well-lg">
                                                        <h4 class="media-heading text-lowercase reviews"> @ {{ $writer->username }} </h4>
                            ...
                            <div class="tab-pane" id="add-comment">
                                <form action="{{ route('Admin.orderAdminComments') }}" method="post" class="form-horizontal" id="commentForm" role="form"> 
